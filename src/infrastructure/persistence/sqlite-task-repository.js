...
class SqliteTaskRepository {
  ...
  taskToRow(task) {
    return {
      ...
      completed_at: task.completedAt ? (task.completedAt instanceof Date ? task.completedAt.toISOString() : task.completedAt) : null,
      started_at: task.startedAt ? (task.startedAt instanceof Date ? task.startedAt.toISOString() : task.startedAt) : null,
