...
.ai-provider-header {
  @apply flex items-center p-4 cursor-pointer transition-all duration-200 bg-card hover:bg-muted/50;
}
...
.ai-provider-config {
  @apply px-4 pb-4 bg-background border-t border-border;
...
.ai-provider-chevron {
  @apply w-5 h-5 text-muted-foreground transition-transform duration-200;
}

.ai-provider-chevron-expanded {
  @apply rotate-90;
}
...
.custom-provider-delete-btn {
  @apply p-1 text-muted-foreground hover:text-destructive transition-colors duration-200;
}
...
.add-custom-provider-btn {
  @apply flex items-center justify-center gap-2 w-full p-3 border-2 border-dashed border-border;
  @apply rounded-lg text-muted-foreground hover:border-primary hover:text-primary transition-colors duration-200;
}
